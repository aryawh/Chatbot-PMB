...
# praproses data
# case folding -> transformasi huruf kapital ke non kapital, dan menghilangkan tanda baca
...
# interaksi dengan bot kami
print("[INFO] Anda Sudah Terhubung dengan Bot PMB Kami")
while True:
    chat = input("Anda >> ")
